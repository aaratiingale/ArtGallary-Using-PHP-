...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $quantity = $values["art_quantity"];
    $price =  $values["art_price"];
    $total = ($values["art_quantity"] * $values["art_price"]);
    $R_ID = $values["A_ID"];
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (A_ID, Artname, price,  quantity, order_date, username, A_ID) 
              VALUES ('" . $F_ID . "','" . $artname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $R_ID . "')";
