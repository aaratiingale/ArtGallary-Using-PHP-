...
<html>
  ...
  <head>
    <title> Contact | Art Gallary </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="artlist.php"><span class="glyphicon glyphicon-cutlery"></span> Food Zone </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Art Gallary </span>?</strong>
     <br>
